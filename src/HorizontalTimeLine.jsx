...
export default class HorizontalTimeline extends React.Component{
    ...
    renderListItems(){
        if(this.props.values){
            return(
                this.props.values.map((timeElement, index)=>{
                    return (
                        <li key={index} className="list-items" href='#' id={index} onClick={this.handleClick}>{timeElement}</li>)
                })
            )
        }
    }
        ...
        return(
            <React.Fragment>
                <Grid container spacing={3}>
                    <Grid item xs={3}>
                        <IconButton className="prvButton iconButton" onClick={this.handleForwardClick} >
                            <ArrowBackIosIcon/>
                        </IconButton>
                    </Grid>
                    <Grid item xs={6}>
                        ...
                        <div id="menu-outer">
                            <div className="table">
                                <ul id="horizontal-list" onWheel={this.handleScroll} onTouchMove={this.handleScroll}>
                    ...
                    <Grid item xs={3}>
                        <IconButton className="iconButton" onClick={this.handleBackwardClick} >
                            <ArrowForwardIosIcon/>
                        </IconButton>
                    </Grid>
                </Grid>
